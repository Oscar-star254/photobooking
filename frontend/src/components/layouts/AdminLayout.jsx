    ...
    <>
      ...
      <aside className={`fixed top-0 left-0 h-full w-64 bg-dark-800 border-r border-white/5 z-50
        ...
        <div className="p-4 mx-4 my-3 bg-brand-500/10 border border-brand-500/20 rounded-lg">
          <div className="text-brand-400 text-xs font-body font-semibold uppercase tracking-widest mb-1">
            Admin Panel
          </div>
        ...
        <div className="px-4 pb-2">
          <Link
            to="/"
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg w-full text-sm font-body text-gray-500 hover:text-gray-300 hover:bg-white/5 transition-colors">
      ...
      <main className="flex-1 lg:ml-64 min-h-screen bg-dark-900">
        ...
        <div className="lg:hidden flex items-center justify-between p-4 border-b border-white/5 bg-dark-800 sticky top-0 z-30">
          ...
          <span className="font-display font-bold text-white text-sm">
            Lens<span className="text-brand-400">Kenya</span> Admin
          </span>
          <div className="w-5" />
        </div>
